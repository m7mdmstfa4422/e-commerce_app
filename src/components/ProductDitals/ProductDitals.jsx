...
export default function ProductDetails() {
    ...
    return (
        <div className="min-h-screen bg-neutral-100 dark:bg-neutral-900 transition-colors duration-300 mt-16">
            ...
            <div className="container mx-auto px-4 py-12">
                ...
                {relatedProducts?.length > 0 && (
                    <div className="mt-16">
                        <h2 className="text-2xl font-bold text-neutral-900 dark:text-white mb-8">You May Also Like</h2>
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-5">
                            {relatedProducts.map((product) => (
                                <div
                                    key={product.id}
                                    className="group bg-white dark:bg-neutral-800 rounded-lg border border-gray-100 dark:border-neutral-700 hover:border-emerald-400 dark:hover:border-emerald-500 transition-all duration-200 flex flex-col h-full"
                                >
                                    <Link
                                    ...
                                    >
                                        <div className="relative overflow-hidden aspect-square">
                                            ...
                                            />
                                            <div className="absolute bottom-2 right-2 bg-white/90 dark:bg-neutral-900/90 px-2 py-1 rounded-full flex items-center shadow-sm">
                                    ...
                                    <div className="p-4 pt-0 flex gap-2">
                                        <button
                                            ...
                                            className={`flex-grow ${loadingStates[product.id]
