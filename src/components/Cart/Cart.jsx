                ...
                {Products && Products.length > 0 ? (
                    <>
                        <button
                            ...
                            className="mb-10 bg-red-600 hover:bg-red-700 text-white px-3 py-1 sm:px-4 sm:py-2 rounded-lg transition-colors duration-300 flex items-center gap-2 mx-auto disabled:opacity-50 disabled:cursor-not-allowed text-sm sm:text-base"
                        >
                            {loading ? (
